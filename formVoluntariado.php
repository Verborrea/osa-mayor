		...
		<main>
			<div id="cons-container">
				<div id="contact-image">
					<img src="media/imgs/hab5.jpg">
				</div>
					<div>
							<h1>¡Gracias por tu interés!</h1>
							<p>Pronto nos comunicaremos contigo para que formes parte de nuestra constelación</p>
					...
					<?php
							...
							$sql = "INSERT INTO voluntarios (nombre,fechaNac,email,ocupacion,sexo,numeroContacto,sobreMi) VALUES ('$name','$date','$email','$job','$sexo','$numero','$resume')";
